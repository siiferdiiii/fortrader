...
const App = {
    ...
    async init() {
        ...
        // Initialize UI modules (Auth must be first for session check)
        await Auth.init();

        // Initialize feature modules after auth is ready
        await Methods.init();
        Charts.init();
        await Backtest.init();
        Sessions.init();
        ...
        // Handle Supabase auth redirect params (email verify, password reset)
